...
const EconomyCarsDetails = () => {
  const economyCars = [
    {
      id: 1,
      name: "سيارة اقتصادية متميزة",
      // الصور مع سنة الموديل لكل واحدة
      images: [
        { src: img1, year: "2024" },
        { src: img2, year: "2023" },
      ],
      specs: { passengers: 5, transmission: "أتوماتيك", engine: "1.6L" },
      whatsappLink: "https://wa.me/9659030061?text=أريد حجز سيارة اقتصادية",
    },
    {
      id: 2,
      name: "سيارة اقتصادية مريحة",
      images: [
        { src: img2, year: "2024" },
        { src: img1, year: "2022" },
      ],
    ...
    <>
      ...
      <Container className="my-5" dir="rtl">
        ...
        <Row className="gx-4 gy-4 my-4">
          {economyCars.map((car) => (
            // التعديل: lg={6} لظهور كرتين في السطر باللابتوب
                    ...
                    <Carousel.Item key={index}>
                      ...
                      >
                        ...
                        <img
                          ...
                          style={{
                            aspectRatio: "16 / 9",
                            objectFit: "contain", // لعدم قص السيارة
                            padding: "5px",
                          }}
                        />
                      </div>
