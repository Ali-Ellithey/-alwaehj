...
export const Footer = () => {
  const { t } = useTranslation(); // 2️⃣ استخدام دالة t لجلب النصوص
  ...
  return (
    <footer
      ...
      style={{
        ...
        // تم إزالة direction الثابتة لتعتمد على لغة الموقع
      }}
    >
      <Container>
        <Row className="gy-5 align-items-center">
          {/* 1️⃣ الجانب الأول: تواصل معنا */}
          <Col xs={12} md={4} className="text-center text-md-start">
            ...
            <div className="d-flex justify-content-center justify-content-md-start gap-4 fs-2">
              ...
              <a href="tel:+9659030061" className="text-white decoration-none">
                <FaPhoneAlt
                  className="footer-icon"
                  style={{ transition: "0.3s", cursor: "pointer" }}
          ...
          {/* 2️⃣ الجانب الثاني: نبذة عن الشركة */}
          <Col
            xs={12}
            md={4}
          ...
          <Col xs={12} md={4} className="text-center text-md-end">
            ...
            <div className="mt-3">
              <p className="small text-muted mb-0">
                <span className="d-block">{t("open_daily")}</span>
                {t("working_hours")}
              </p>
            </div>
          </Col>
