  ...
  const suvCars = [
    {
      ...
      whatsappLink:
        "https://wa.me/96590300619?text=أريد حجز بنتلي بينتايجا SUV",
    },
    {
      id: 2,
      ...
      whatsappLink: "https://wa.me/9659030061?text=أريد حجز رولز رويس SUV",
    },
  ];
    ...
    <>
      ...
      <Container className="my-5" dir="rtl">
        ...
        <Row className="gx-4 gy-4 my-4">
          {suvCars.map((car) => (
            // lg={6} لظهور كرتين في السطر باللابتوب وكرت واحد بالموبايل
