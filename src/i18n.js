...
const resources = {
    en: {
        translation: {
            ...
            // داخل قسم en:
            "business": {
                "launch_today": "Start today. Leave the mission of securing your car to",
                "brand_name": "Wahaj Al-Alamiya",
                "tagline": "We are not just an option, we are the certain decision for every successful trip in Kuwait."
            },
            // في قسم en:
            ...
            "about": {
                ...
                "right_side": {
                    "title": "Drive with Style and Confidence with Wahaj Al-Alamiya, your partner in Kuwait",
                    "strength_label": "Our Strength",
                    "strength_text": "Diversity that meets every ambition. We understand that mobility needs change.",
                    "suv_text": "Unlimited power and space for adventurers, a comfortable and safe driving experience.",
                    "luxury_text": "The language of elegance and distinction when first impressions matter most.",
                    "economy_text": "Smart efficiency for your daily commutes, fuel economy, and absolute reliability."
                }
            },
            // داخل قسم en:
            "slider": {
            ...
            "fleet": {
                ...
                "categories": {
                    ...
                    "economy": { "name": "Economy Cars", "desc": "Practical and affordable cars for your daily needs." },
                    "suv": { "name": "SUV Cars", "desc": "Outstanding power and performance on all Kuwaiti roads." },
                    "family": { "name": "Family Cars", "desc": "Space, comfort, and safety for all your family members." }
                }
            },// داخل قسم en:
            "testimonials": {
    ...
    ar: {
        translation: {
            ...
            "economy_cars": "سيارات اقتصادية",
            "suv_cars": "سيارات SUV",
            "family_cars": "سيارات عائلية",
            ...
            "our_location": "موقعنا",
            "address_details": "القاهرة، مدينة نصر، شارع عباس العقاد",
            "open_daily": "مفتوح يومياً",
            "working_hours": "9:00 ص - 10:00 م",
            "services_title": "خدماتنا",
            // داخل ملف i18n.js في قسم ar:
            "invest": {
            ...
            // داخل قسم ar:
            "business": {
                "launch_today": "انطلق اليوم. اترك مهمة تأمين سيارتك على",
                "brand_name": "واهج العالمية",
                "tagline": "نحن لسنا مجرد خيار، بل نحن القرار الأكيد لكل رحلة موفقة في الكويت."
            },
            // في قسم ar:
            ...
            "about": {
                ...
                "tabs": {
                    ...
                    "airport": "ليموزين المطار",
                    "needs": "احتياجاتك الخاصة"
                },
                "right_side": {
                    "title": "انطلق بأناقة وثقة مع واهج العالمية",
                    "strength_label": "سر قوتنا",
                    "strength_text": "التنوع الذي يلبي كل طموح. نحن نفهم أن متطلبات التنقل تتغير.",
                    "suv_text": "القوة والرحابة بلا حدود للمغامرين، تجربة قيادة مريحة وآمنة.",
                    "luxury_text": "لغة الأناقة والتميز عندما تكون الانطباعات الأولى هي الأهم.",
                    "economy_text": "الكفاءة الذكية لتنقلاتك اليومية، توفير الوقود والاعتمادية المطلقة."
                }
            }
            ,// داخل قسم ar:
            "slider": {
            ...
            "fleet": {
                ...
                "more_btn": "المزيد",
                "categories": {
                    "luxury": { "name": "سيارات فاخرة", "desc": "أفضل السيارات الفاخرة للإيجار مع سائق في الكويت." },
                    "economy": { "name": "سيارات اقتصادية", "desc": "سيارات عملية واقتصادية تناسب احتياجاتك اليومية." },
                    "suv": { "name": "سيارات دفع رباعي", "desc": "قوة وأداء متميز على جميع الطرقات في الكويت." },
                    "family": { "name": "سيارات عائلية", "desc": "مساحة وراحة وأمان لجميع أفراد عائلتك." }
                }
            },// داخل قسم ar:
            "testimonials": {
                "main_title": "واهج لتأجير السيارات",
                "slide1": {
                    "text": "“في واهج لتأجير السيارات، نقدم مجموعة واسعة من خدمات السيارات والليموزين لرجال الأعمال من خلال أسطول يتكون من أحدث موديلات السيارات الفاخرة الحديثة، وسائقين محترفين لضمان جودة تجربة فريدة وخدمة متميزه.”"
                },
                "slide2": {
                    "text": "“استأجر سيارتك الفاخرة بثلاث خطوات سهلة مع شركة واهج لتأجير السيارات. نؤمن بأن القيادة يجب أن تكون سهلة وممتعة. واهج هي بوابتك إلى عالم السفر الفاخر في الكويت. يمكنك حجز سيارة أحلامك فورًا عبر واتساب بدون استمارات أو دفعات مقدمة.”"
                }
            }
